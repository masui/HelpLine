var data = 
{
  "codes": [],
  "defs": [
    "$ Compare file xxxx with the one from 2 days ago {8}",
    ...
    "% git diff $(git rev-list -n 1 HEAD -- #{$1})^^ -- #{$1} {8}",
    "$ ファイル「(#{files})」の編集履歴を完全に(#{delete})がワーキングツリーは残す {10}",
    "% git filter-branch -f --index-filter 'git rm --cached --ignore-unmatch #{$1}' HEAD {10}",
    "$ ファイル「(#{files})」の編集履歴を完全に(#{delete}) {10}",
    "% git filter-branch -f --index-filter 'git rm --ignore-unmatch #{$1}' HEAD {10}",
    "$ 編集履歴をGitHubに反映させる {10}",
    "% git push origin --force --all {10}",
    "$ ファイル「(#{files})」の(#{numbers})分前からの(#{change})履歴を(#{display}) {11}",
    "% git log --since \"#{$2} minutes ago\" #{$1} {11}",
    "$ (#{numbers})分前からのファイル「(#{files})」の(#{change})履歴を(#{display}) {11}",
    "% git log --since \"#{$1} minutes ago\" #{$2} {11}",
    "$ ファイル「(#{files})」の(#{numbers})分前からの(#{change})を(#{display}) {11}",
    "% git diff HEAD \"@{#{$2} minutes ago}\" #{$1} {11}",
    "$ (#{numbers})分前からのファイル「(#{files})」の(#{change})を(#{display}) {11}",
    "% git diff HEAD \"@{#{$1} minutes ago}\" #{$2} {11}",
    "$ ファイル「(#{files})」の(#{numbers})時間前からの(#{change})履歴を(#{display}) {11}",
    "% git log --since \"#{$2} hours ago\" #{$1} {11}",
    "$ (#{numbers})時間前からのファイル「(#{files})」の(#{change})履歴を(#{display}) {11}",
    "% git log --since \"#{$1} hours ago\" #{$2} {11}",
    "$ ファイル「(#{files})」の(#{numbers})時間前からの(#{change})を(#{display}) {11}",
    "% git diff HEAD \"@{#{$2} hours ago}\" #{$1} {11}",
    "$ (#{numbers})時間前からのファイル「(#{files})」の(#{change})を(#{display}) {11}",
    "% git diff HEAD \"@{#{$1} hours ago}\" #{$2} {11}",
    "$ ファイル「(#{files})」の(#{numbers})日前からの(#{change})履歴を(#{display}) {11}",
    "% git log --since \"#{$2} days ago\" #{$1} {11}",
    "$ (#{numbers})日前からのファイル「(#{files})」の(#{change})履歴を(#{display}) {11}",
    "% git log --since \"#{$1} days ago\" #{$2} {11}",
    "$ ファイル「(#{files})」の(#{numbers})日前からの(#{change})を(#{display}) {11}",
    "% git diff HEAD \"@{#{$2} days ago}\" #{$1} {11}",
    "$ (#{numbers})日前からのファイル「(#{files})」の(#{change})を(#{display}) {11}",
    "% git diff HEAD \"@{#{$1} days ago}\" #{$2} {11}",
    "$ ファイルを新しい順に(リスト|表示)する {12}",
    "% git ls-files | xargs ls -l -t {12}",
