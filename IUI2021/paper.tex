...
\begin{figure}[H]
  \centering
  \includegraphics[width=12cm,bb=0 0 1290 1090]{figures/eaa80e41ddc3d3620fae133007274573.png}
...
\item \textbf{Approximate pattern matching}
  ...
  Using the ExpandSearch algorithm, all the expressions are expanded in advance,
...
\item \textbf{Document expansion by users}
  ...
  other users can add the {\ES} entries.
  This strategy is very similar to writing a hands-on document for an existing document,
  but adding {\ES} entries is much easier than authoring  a document from scratch.
...
Some Unix command line tools have many options and features that are difficult to remember.
