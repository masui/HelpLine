...
\begin{figure}[h]
  ...
  \centerline{\includegraphics[width=8cm,bb=0 0 300 200]{figures/mac1.png}}
  \caption{Using {\EH} in the menu bar of MacOS.}
  \label{mac1}
\end{figure}

\begin{figure}[h]
  %\centerline{\includegraphics[width=8cm,bb=0 0 392 185]{figures/mac2.png}}
  \centerline{\includegraphics[width=8cm,bb=0 0 300 130]{figures/mac2.png}}
  \caption{Using {\EH} in the menu bar of MacOS.}
  \label{mac2}
\end{figure}
